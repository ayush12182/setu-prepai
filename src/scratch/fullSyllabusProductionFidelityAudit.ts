...
const FULL_SYLLABUS: ChapterDef[] = [
  ...
  { id: 'phy-4',  name: 'System of Particles & Centre of Mass',    subject: 'physics',     topics: ['Centre of Mass discrete system', 'Centre of Mass continuous bodies', 'Motion of Centre of Mass', 'Momentum Conservation & Recoil', 'Impulse & Variable Force', 'Collisions (1D & 2D)', 'Variable Mass Rocket Propulsion'] },
  { id: 'phy-5',  name: 'Rotational Motion',                      subject: 'physics',     topics: ['Moment of Inertia', 'Parallel & Perpendicular Axis Theorems', 'Torque & Angular Momentum', 'Rotational Kinematics', 'Rolling Motion', 'Angular Impulse', 'Toppling vs Sliding'] },
  { id: 'phy-6',  name: 'Gravitation',                            subject: 'physics',     topics: ["Newton's Law of Gravitation", 'Gravitational Field & Potential', 'Orbital Motion', 'Escape & Orbital Velocity', "Kepler's Laws", 'Satellites'] },
  { id: 'phy-7',  name: 'Mechanical Properties of Solids',         subject: 'physics',     topics: ['Elastic behavior', 'Stress-strain relationship', "Hooke's law", "Young's modulus, bulk modulus, shear modulus", "Poisson's ratio", 'Elastic potential energy in stretched wire'] },
  { id: 'phy-8',  name: 'Mechanical Properties of Fluids',         subject: 'physics',     topics: ["Fluid Pressure & Pascal's Law", 'Buoyancy & Archimedes Principle', "Viscosity & Stokes' Law", 'Terminal Velocity', 'Equation of Continuity', "Bernoulli's Theorem & Applications", 'Surface Tension & Excess Pressure', 'Capillarity'] },
  { id: 'phy-9',  name: 'SHM & Waves',                            subject: 'physics',     topics: ['Simple Harmonic Motion', 'Spring-Mass System', 'Simple Pendulum', 'Wave Equation', 'Superposition', 'Standing Waves', 'Beats & Doppler Effect'] },
  { id: 'phy-10', name: 'Thermodynamics',                         subject: 'physics',     topics: ['First Law of Thermodynamics', 'Thermodynamic Processes', 'Heat Engines', 'Carnot Cycle', 'Entropy', 'Kinetic Theory of Gases'] },
  { id: 'phy-11', name: 'Electrostatics',                         subject: 'physics',     topics: ["Coulomb's Law", 'Electric Field', "Gauss's Law", 'Electric Potential', 'Capacitors', 'Dielectrics'] },
  { id: 'phy-12', name: 'Current Electricity',                    subject: 'physics',     topics: ["Ohm's Law", 'Resistance & Resistivity', "Kirchhoff's Laws", 'RC Circuits', 'Electrical Instruments', 'Heating Effect'] },
  { id: 'phy-13', name: 'Magnetism & EMI',                        subject: 'physics',     topics: ['Biot-Savart Law', "Ampere's Law", 'Magnetic Force on Current', "Faraday's Law", "Lenz's Law", 'Inductance', 'AC Circuits'] },
  { id: 'phy-14', name: 'Optics',                                 subject: 'physics',     topics: ['Reflection & Mirrors', 'Refraction & Lenses', 'Prism & Dispersion', 'Interference', 'Diffraction', 'Polarization'] },
  { id: 'phy-15', name: 'Modern Physics',                         subject: 'physics',     topics: ['Photoelectric Effect', 'Bohr Model', 'X-rays', 'Nuclear Physics', 'Radioactivity', 'Semiconductors'] },
  // ── CHEMISTRY ───────────────────────────────────────────────────────────
