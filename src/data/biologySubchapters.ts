...
export const cellBiologySubchapters: Subchapter[] = [
    {
        ...
        setuLine: 'Prokaryotes simple hain par tricky. Cell envelope aur organelles pakka karo.'
    },
    {
        id: 'neet-bio-1-2',
        chapterId: 'neet-bio-1',
        ...
        setuLine: 'Endomembrane system connected hai. ER -> Golgi -> Lysosome/Vacuole sequence yaad rakho.'
    },
    {
        id: 'neet-bio-1-3',
        chapterId: 'neet-bio-1',
        ...
        setuLine: 'Powerhouse aur Kitchen. Dono ke paas apna DNA hai. Important details.'
    },
    {
        id: 'neet-bio-1-4',
        chapterId: 'neet-bio-1',
        ...
        setuLine: 'Nucleus controller hai. Chromosome types aur unki shapes anaphase mein yaad rakhna.'
    }
];
...
export const humanPhysiologySubchapters: Subchapter[] = [
    {
        ...
        setuLine: 'Enzymes, source, aur pH. Ye table banalo, sab clear ho jayega.'
    },
    {
        id: 'neet-bio-2-2',
        chapterId: 'neet-bio-2',
        ...
        setuLine: 'Volumes aur Curve. Ye do topics se hi maximum questions aate hain.'
    },
    {
        id: 'neet-bio-2-3',
        chapterId: 'neet-bio-2',
        ...
        setuLine: 'ECG aur Cardiac Cycle ko visualise karo. Flow chart banao blood ka.'
    },
    {
        id: 'neet-bio-2-4',
        chapterId: 'neet-bio-2',
        ...
        setuLine: 'Counter current mechanism most logical topic hai. Diagram se samjho.'
    }
];
...
export const plantPhysiologySubchapters: Subchapter[] = [
    {
        ...
        setuLine: 'Z-scheme aur C3/C4 cycles. Steps aur location yaad honi chahiye.'
    },
    {
        id: 'neet-bio-3-2',
        chapterId: 'neet-bio-3',
        ...
        setuLine: 'Cycles hain, par energy (ATP) count karna mat bhoolna.'
    },
    {
        id: 'neet-bio-3-3',
        chapterId: 'neet-bio-3',
        ...
        setuLine: 'Hormones ki table banao - Discovery, Precursor, Function. Direct questions.'
    }
];
...
export const geneticsSubchapters: Subchapter[] = [
    {
        ...
        setuLine: 'Ratios (3:1, 9:3:3:1) aur unke exceptions. Logic lagao, ratto mat.'
    },
    {
        id: 'neet-bio-4-2',
        chapterId: 'neet-bio-4',
        ...
        setuLine: 'Central Dogma: DNA -> RNA -> Protein. Process aur enzymes critical hain.'
    }
];
...
export const ecologySubchapters: Subchapter[] = [
    {
        ...
        setuLine: 'Interactions (+, -, 0) aur Growth curves. Examples NCERT se bahar mat jaana.'
    },
    {
        id: 'neet-bio-5-2',
        chapterId: 'neet-bio-5',
        ...
        setuLine: 'Energy flow unidirectional hai. 10% law simple hai par important.'
    }
];
...
export const reproductionSubchapters: Subchapter[] = [
    {
        ...
        setuLine: 'Diagrams aur Hormonal control graph. Wahi se question banega.'
    },
    {
        id: 'neet-bio-6-2',
        chapterId: 'neet-bio-6',
        ...
        setuLine: 'Contraceptives aur ART full forms. Chhota chapter, full marks.'
    }
];
...
export const biotechSubchapters: Subchapter[] = [
    {
        ...
        setuLine: 'Tools of biotechnology: Enzymes aur Vectors. pBR322 diagram ratt lo.'
    }
];
...
export const animalKingdomSubchapters: Subchapter[] = [
    {
        ...
        setuLine: 'Examples aur distinctive features. "Exceptions" hi rules hain yahan.'
    }
];
...
export const plantKingdomSubchapters: Subchapter[] = [
    {
        ...
        setuLine: 'Life cycles (Alternation of generation) aur Algae pigments table.'
    }
];
...
export const humanHealthSubchapters: Subchapter[] = [
    {
        ...
        setuLine: 'Diseases ki list: Cause, Symptom, Test. Aur Immunity ke types.'
    }
];
