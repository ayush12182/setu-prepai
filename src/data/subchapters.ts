...
export interface Subchapter {
  ...
  setuLine: string;        // One calm teacher line
}
...
export const kinematicsSubchapters: Subchapter[] = [
  {
    ...
    setuLine: 'Beta, 1D motion is your foundation. Master signs and directions first.'
  },
  {
    id: 'phy-1-2',
    chapterId: 'phy-1',
    ...
    setuLine: 'X alag, Y alag. Time same. Bas itna yaad rakho.'
  },
  {
    id: 'phy-1-3',
    chapterId: 'phy-1',
    ...
    setuLine: 'Graph padho jaise kahani padh rahe ho. Slope aur area tumhare dost hain.'
  },
  {
    id: 'phy-1-4',
    chapterId: 'phy-1',
    ...
    setuLine: 'Projectile mein horizontal motion free hai, vertical mein gravity ka drama.'
  },
  {
    id: 'phy-1-5',
    chapterId: 'phy-1',
    ...
    setuLine: 'Apni speed minus uski speed. Simple vector subtraction. Tension mat lo.'
  },
  {
    id: 'phy-1-6',
    chapterId: 'phy-1',
    ...
    setuLine: 'Gravity hamesha neeche kheenchti hai. Upar jaao ya neeche, g = 9.8 m/s².'
  }
];
...
export const lawsOfMotionSubchapters: Subchapter[] = [
  {
    ...
    setuLine: 'Newton ke teen rules hi poora mechanics hai. Isko pakka karo.'
  },
  {
    id: 'phy-2-2',
    chapterId: 'phy-2',
    ...
    setuLine: 'FBD sahi bana, aadha problem solve. Galat FBD = guaranteed wrong answer.'
  },
  {
    id: 'phy-2-3',
    chapterId: 'phy-2',
    ...
    setuLine: 'Static friction adjust karti hai. Kinetic fix rehti hai. Yahi fark hai.'
  },
  {
    id: 'phy-2-4',
    chapterId: 'phy-2',
    ...
    setuLine: 'Circle mein koi force center ki taraf lagti hai. Usse pehchano, kaam ban jayega.'
  },
  {
    id: 'phy-2-5',
    chapterId: 'phy-2',
    ...
    setuLine: 'Jab frame accelerate kare, pseudo force lagao. Warna Newton naraz.'
  },
  {
    id: 'phy-2-6',
    chapterId: 'phy-2',
    ...
    setuLine: 'String ka total length constant. Isse equation banao, constraint mil jayega.'
  }
];
...
export const workEnergySubchapters: Subchapter[] = [
  {
    ...
    setuLine: 'Work = Force × displacement × cos(angle). Angle 90° ho toh work zero.'
  },
  {
    id: 'phy-3-2',
    chapterId: 'phy-3',
    ...
    setuLine: 'Total work = kinetic energy ka change. Simple hai, complicate mat karo.'
  },
  {
    id: 'phy-3-3',
    chapterId: 'phy-3',
    ...
    setuLine: 'Conservative forces mein energy conservation lagao. Friction ho toh nahi.'
  },
  {
    id: 'phy-3-4',
    chapterId: 'phy-3',
    ...
    setuLine: 'PE curve ka slope = negative force. Minima stable, maxima unstable.'
  },
  {
    id: 'phy-3-5',
    chapterId: 'phy-3',
  ...
  },
  {
    ...
    setuLine: 'Power = rate of doing work. Vehicle problems mein P = F.v use karo.'
  }
];
...
export const rotationalMotionSubchapters: Subchapter[] = [
  ...
  },
  {
    ...
    setuLine: 'Slide ya topple - dono conditions check karo, jo pehle ho wahi answer.'
  }
];
...
export const gravitationSubchapters: Subchapter[] = [
  ...
  },
  {
    ...
    setuLine: 'Kepler ke laws angular momentum conservation se aate hain. Physics beautiful hai.'
  }
];
...
export const electrostaticsSubchapters: Subchapter[] = [
  ...
  },
  {
    ...
    setuLine: 'Dielectric daalo, capacitance badho. K = dielectric constant yaad rakho.'
  }
];
...
export const shmWavesSubchapters: Subchapter[] = [
  ...
  },
  {
    ...
    setuLine: 'Doppler mein approach = frequency badho, recede = frequency giro.'
  }
];
...
export const currentElectricitySubchapters: Subchapter[] = [
  ...
  },
  {
    ...
    setuLine: 'Power formula choose karo based on kya constant hai - I ya V.'
  }
];
...
export const modernPhysicsSubchapters: Subchapter[] = [
  ...
  },
  {
    ...
    setuLine: 'n-type mein electron majority, p-type mein hole. Diode ek taraf conduct karta hai.'
  }
];
...
export const opticsSubchapters: Subchapter[] = [
  ...
  },
  {
    ...
    setuLine: 'Diffraction single slit se, interference double slit se. Dono alag hain.'
  }
];
...
export const thermodynamicsSubchapters: Subchapter[] = [
  ...
  },
  {
    ...
    setuLine: 'γ = Cp/Cv. Gas type se γ pata chalta hai. Formulas yaad rakho.'
  }
];
...
export const magnetismSubchapters: Subchapter[] = [
  ...
  },
  {
    ...
    setuLine: 'AC mein impedance, DC mein resistance. Resonance pe power maximum.'
  }
];
...
export const moleConceptSubchapters: Subchapter[] = [
  {
    ...
    setuLine: 'Mole = Avogadro number particles. Mass se mole, mole se number.'
  },
  {
    id: 'chem-1-2',
    chapterId: 'chem-1',
    ...
    setuLine: 'Percentage se empirical formula nikalo. Molecular weight se n nikalo.'
  },
  {
    id: 'chem-1-3',
    chapterId: 'chem-1',
    ...
    setuLine: 'Jo pehle khatam ho, wo limiting. Product usse nikalo.'
  },
  {
    id: 'chem-1-4',
    chapterId: 'chem-1',
    ...
    setuLine: 'Molarity mein solution volume, molality mein solvent mass. Fark yaad rakho.'
  },
  {
    id: 'chem-1-5',
    chapterId: 'chem-1',
    ...
    setuLine: 'Titration mein equivalents equal hote hain at end point. N₁V₁ = N₂V₂.'
  }
];
...
export const atomicStructureSubchapters: Subchapter[] = [
  {
    ...
    setuLine: 'Bohr model = quantized orbits. Energy -13.6/n² for hydrogen.'
  },
  {
    id: 'chem-2-2',
    chapterId: 'chem-2',
    ...
    setuLine: 'Four quantum numbers = complete address of electron. Valid combinations check karo.'
  },
  {
    id: 'chem-2-3',
    chapterId: 'chem-2',
    ...
    setuLine: 'Configuration mein Cr aur Cu yaad rakho. Half aur full filled stable hai.'
  },
  {
    id: 'chem-2-4',
    chapterId: 'chem-2',
    ...
    setuLine: 'Photoelectric = particle nature. de Broglie = wave nature. Duality hai.'
  }
];
...
export const chemicalBondingSubchapters: Subchapter[] = [
  {
    ...
    setuLine: 'VSEPR = electron pair repulsion. Lone pairs ka dabav zyada.'
  },
  {
    id: 'chem-3-2',
    chapterId: 'chem-3',
    ...
    setuLine: 'Steric number se hybridization. Geometry shape pe depend karta hai.'
  },
  {
    id: 'chem-3-3',
    chapterId: 'chem-3',
    ...
    setuLine: 'MOT mein bond order nikalo. Unpaired electrons = paramagnetic.'
  },
  {
    id: 'chem-3-4',
    chapterId: 'chem-3',
    ...
    setuLine: 'Dipole moment vector hai. Symmetric molecules mein cancel ho jata hai.'
  }
];
...
export const chemThermodynamicsSubchapters: Subchapter[] = [
  {
    ...
    setuLine: 'First law = energy conservation. ΔU = q + w yaad rakho.'
  },
  {
    id: 'chem-4-2',
    chapterId: 'chem-4',
    ...
    setuLine: "Hess law = state function. Kisi bhi path se jao, ΔH same."
  },
  {
    id: 'chem-4-3',
    chapterId: 'chem-4',
    ...
    setuLine: 'ΔG negative = spontaneous. Temperature ka role check karo.'
  }
];
...
export const chemicalEquilibriumSubchapters: Subchapter[] = [
  {
    ...
    setuLine: 'Q < K = forward. Q > K = backward. Q = K = equilibrium.'
  },
  {
    id: 'chem-5-2',
    chapterId: 'chem-5',
    ...
    setuLine: 'System change ka oppose karta hai. Le Chatelier simple hai.'
  },
  {
    id: 'chem-5-3',
    chapterId: 'chem-5',
    ...
    setuLine: 'pH calculation mein pehle strong ya weak check karo.'
  },
  {
    id: 'chem-5-4',
    chapterId: 'chem-5',
    ...
    setuLine: 'Buffer = weak acid + salt. Henderson equation master karo.'
  },
  {
    id: 'chem-5-5',
    chapterId: 'chem-5',
    ...
    setuLine: 'Q > Ksp = precipitation. Simple comparison hai.'
  }
];
...
export const electrochemistrySubchapters: Subchapter[] = [
  {
    ...
    setuLine: 'E°cell positive = spontaneous. Cathode mein reduction.'
  },
  {
    id: 'chem-6-2',
    chapterId: 'chem-6',
    ...
    setuLine: 'Nernst equation se non-standard E nikalo. 0.059/n yaad rakho.'
  },
  {
    id: 'chem-6-3',
    chapterId: 'chem-6',
    ...
    setuLine: 'Faraday laws se mass nikalo. m = ZIt formula use karo.'
  },
  {
    id: 'chem-6-4',
    chapterId: 'chem-6',
    ...
    setuLine: 'Kohlrausch law se weak electrolyte ka Λm° nikalo.'
  }
];
...
export const chemicalKineticsSubchapters: Subchapter[] = [
  {
    ...
    setuLine: 'Order experimental se, molecularity theoretical. Fark yaad rakho.'
  },
  {
    id: 'chem-7-2',
    chapterId: 'chem-7',
    ...
    setuLine: 'First order ka half-life concentration pe depend nahi karta.'
  },
  {
    id: 'chem-7-3',
    chapterId: 'chem-7',
    ...
    setuLine: 'Arrhenius se Ea nikalo. Temperature badhao, k badhega.'
  }
];
...
export const gocIsomerismSubchapters: Subchapter[] = [
  {
    ...
    setuLine: 'I effect through sigma, R effect through pi. Simple hai.'
  },
  {
    id: 'chem-8-2',
    chapterId: 'chem-8',
    ...
    setuLine: 'Carbocation mein electron chahiye. Carbanion mein electron hatana hai.'
  },
  {
    id: 'chem-8-3',
    chapterId: 'chem-8',
    ...
    setuLine: 'Structural isomers = same formula, different structure. Count carefully.'
  },
  {
    id: 'chem-8-4',
    chapterId: 'chem-8',
    ...
    setuLine: 'R/S mein priority assign karo. Lowest priority peeche rakho.'
  }
];
...
export const hydrocarbonsSubchapters: Subchapter[] = [
  {
    ...
    setuLine: 'Alkane mein free radical mechanism. 3° radical sabse stable.'
  },
  {
    id: 'chem-9-2',
    chapterId: 'chem-9',
    ...
    setuLine: 'Markovnikov = H goes to more H. Simple rule.'
  },
  {
    id: 'chem-9-3',
    chapterId: 'chem-9',
    ...
    setuLine: 'Terminal alkyne acidic. Lindlar se cis, Birch se trans.'
  },
  {
    id: 'chem-9-4',
    chapterId: 'chem-9',
    ...
    setuLine: 'Benzene = substitution over addition. Directing effects master karo.'
  }
];
...
export const organicReactionsSubchapters: Subchapter[] = [
  {
    ...
    setuLine: 'SN2 = one step inversion. SN1 = two steps racemization.'
  },
  {
    id: 'chem-10-2',
    chapterId: 'chem-10',
    ...
    setuLine: 'E2 = anti-periplanar compulsory. Saytzeff = more stable alkene.'
  },
  {
    id: 'chem-10-3',
    chapterId: 'chem-10',
    ...
    setuLine: 'Named reactions yaad karo. Reagents aur conditions important.'
  },
  {
    id: 'chem-10-4',
    chapterId: 'chem-10',
    ...
    setuLine: 'Reagent selection important. Mild ya strong oxidation decide karo.'
  }
];
...
export const periodicTableSubchapters: Subchapter[] = [
  {
    ...
    setuLine: 'Trends yaad karo with exceptions. Exceptions zyada poochte hain.'
  },
  {
    id: 'chem-11-2',
    chapterId: 'chem-11',
    ...
    setuLine: 's-block = reactive metals. Diagonal relationship Li-Mg, Be-Al.'
  },
  {
    id: 'chem-11-3',
    chapterId: 'chem-11',
    ...
    setuLine: 'Inert pair effect = heavy elements prefer +2 over +4.'
  },
  {
    id: 'chem-11-4',
    chapterId: 'chem-11',
    ...
    setuLine: 'd-block = variable oxidation. Color due to d-d transition.'
  }
];
...
export const coordinationChemSubchapters: Subchapter[] = [
  {
    ...
    setuLine: 'IUPAC nomenclature practice karo. Ligand names important.'
  },
  {
    id: 'chem-12-2',
    chapterId: 'chem-12',
    ...
    setuLine: 'Coordination isomerism types yaad karo. Geometry se isomer count karo.'
  },
  {
    id: 'chem-12-3',
    chapterId: 'chem-12',
    ...
    setuLine: 'CFT = electrostatic splitting. Strong field ligand = low spin.'
  },
  {
    id: 'chem-12-4',
    chapterId: 'chem-12',
    ...
    setuLine: 'Magnetic moment se unpaired electrons nikalo. Formula simple hai.'
  }
];
...
export const quadraticSubchapters: Subchapter[] = [
  {
    ...
    setuLine: 'D se nature, -b/a se sum, c/a se product. Basic formula.'
  },
  {
    id: 'math-1-2',
    chapterId: 'math-1',
    ...
    setuLine: 'α + β = -b/a yaad rakho. Baki sab derive ho jayega.'
  },
  {
    id: 'math-1-3',
    chapterId: 'math-1',
    ...
    setuLine: 'Location problems mein conditions dhyan se check karo.'
  },
  {
    id: 'math-1-4',
    chapterId: 'math-1',
    ...
    setuLine: 'Vertex pe extreme value. a positive = minima, negative = maxima.'
  }
];
...
export const complexSubchapters: Subchapter[] = [
  {
    ...
    setuLine: 'i ke powers cyclic hain. i⁴ = 1 yaad rakho.'
  },
  {
    id: 'math-2-2',
    chapterId: 'math-2',
    ...
    setuLine: 'Modulus = distance from origin. Argument = angle with positive x-axis.'
  },
  {
    id: 'math-2-3',
    chapterId: 'math-2',
    ...
    setuLine: 'De Moivre = (r∠θ)ⁿ = rⁿ∠nθ. Roots of unity symmetric on circle.'
  },
  {
    id: 'math-2-4',
    chapterId: 'math-2',
    ...
    setuLine: 'Complex plane mein geometry easy hai. Modulus = distance, argument = angle.'
  }
];
...
export const matricesSubchapters: Subchapter[] = [
  {
    ...
    setuLine: 'Matrix multiplication mein order change mat karo. AB ≠ BA mostly.'
  },
  {
    id: 'math-3-2',
    chapterId: 'math-3',
    ...
    setuLine: 'Determinant = signed volume concept. Properties use karke simplify karo.'
  },
  {
    id: 'math-3-3',
    chapterId: 'math-3',
    ...
    setuLine: 'Inverse = adjoint / determinant. |A| = 0 means no inverse.'
  },
  {
    id: 'math-3-4',
    chapterId: 'math-3',
    ...
    setuLine: 'System of equations mein pehle |A| check karo.'
  }
];
...
export const permutationsSubchapters: Subchapter[] = [
  {
    ...
    setuLine: 'OR = add, AND = multiply. Basic counting principle.'
  },
  {
    id: 'math-4-2',
    chapterId: 'math-4',
    ...
    setuLine: 'Permutation = order matters. Identical objects mein divide karo.'
  },
  {
    id: 'math-4-3',
    chapterId: 'math-4',
    ...
    setuLine: 'Combination = selection. Order matter nahi karta.'
  },
  {
    id: 'math-4-4',
    chapterId: 'math-4',
    ...
    setuLine: 'Distribution problems mein identical vs distinct dhyan do.'
  }
];
...
export const probabilitySubchapters: Subchapter[] = [
  {
    ...
    setuLine: 'Basic probability = favorable/total. Equally likely check karo.'
  },
  {
    id: 'math-5-2',
    chapterId: 'math-5',
    ...
    setuLine: 'Conditional probability = reduced sample space. P(A|B) mein B pehle ho chuka.'
  },
  {
    id: 'math-5-3',
    chapterId: 'math-5',
    ...
    setuLine: 'Bayes = reverse probability. Total probability pehle, Bayes baad mein.'
  },
  {
    id: 'math-5-4',
    chapterId: 'math-5',
    ...
    setuLine: 'Binomial = n independent trials. Mean = np yaad rakho.'
  }
];
...
export const limitsSubchapters: Subchapter[] = [
  {
    ...
    setuLine: 'Standard limits yaad karo. sinx/x = 1 most important.'
  },
  {
    id: 'math-6-2',
    chapterId: 'math-6',
    ...
    setuLine: "L'Hôpital = 0/0 ya ∞/∞ mein upar neeche separately differentiate."
  },
  {
    id: 'math-6-3',
    chapterId: 'math-6',
    ...
    setuLine: 'Continuous = no break. LHL = RHL = f(a) check karo.'
  },
  {
    id: 'math-6-4',
    chapterId: 'math-6',
    ...
    setuLine: 'Differentiable means smooth curve. Sharp corner = not differentiable.'
  }
];
...
export const differentiationSubchapters: Subchapter[] = [
  {
    ...
    setuLine: 'Standard derivatives table yaad karo. Chain rule important.'
  },
  {
    id: 'math-7-2',
    chapterId: 'math-7',
    ...
    setuLine: 'Implicit mein y ko x ka function maan ke differentiate karo.'
  },
  {
    id: 'math-7-3',
    chapterId: 'math-7',
    ...
    setuLine: 'Variable power mein log le lo. Baaki easy ho jayega.'
  },
  {
    id: 'math-7-4',
    chapterId: 'math-7',
    ...
    setuLine: 'Higher derivatives mein pattern dhundo. Cycle repeat hoti hai.'
  }
];
...
export const applicationDerivativesSubchapters: Subchapter[] = [
  {
    ...
    setuLine: 'Tangent slope = dy/dx. Normal slope = negative reciprocal.'
  },
  {
    id: 'math-8-2',
    chapterId: 'math-8',
    ...
    setuLine: 'Maxima-minima mein pehle f\' = 0 solve karo, phir check karo.'
  },
  {
    id: 'math-8-3',
    chapterId: 'math-8',
    ...
    setuLine: 'f\' > 0 = increasing. Interval find karo where f\' positive.'
  },
  {
    id: 'math-8-4',
    chapterId: 'math-8',
    ...
    setuLine: "MVT = average slope = instantaneous slope somewhere. Existence theorem hai."
  }
];
...
export const integrationSubchapters: Subchapter[] = [
  {
    ...
    setuLine: 'Integration mein method selection important. Practice se aata hai.'
  },
  {
    id: 'math-9-2',
    chapterId: 'math-9',
    ...
    setuLine: 'Definite integral mein properties use karo. Calculation reduce hoti hai.'
  },
  {
    id: 'math-9-3',
    chapterId: 'math-9',
    ...
    setuLine: 'Area mein upper minus lower integrate karo. Limits intersection se.'
  },
  {
    id: 'math-9-4',
    chapterId: 'math-9',
    ...
    setuLine: 'DE mein method identify karo. Variable separable sabse easy.'
  }
];
...
export const coordinateGeomSubchapters: Subchapter[] = [
  {
    ...
    setuLine: 'Straight line = first form, then apply formula. Basic geometry hai.'
  },
  {
    id: 'math-10-2',
    chapterId: 'math-10',
    ...
    setuLine: 'Circle mein center aur radius nikalo. Tangent length formula yaad karo.'
  },
  {
    id: 'math-10-3',
    chapterId: 'math-10',
    ...
    setuLine: 'Parabola mein 4a important. Focal chord property use karo.'
  },
  {
    id: 'math-10-4',
    chapterId: 'math-10',
    ...
    setuLine: 'Conics mein eccentricity focus distance/directrix distance. e < 1 ellipse, e > 1 hyperbola.'
  }
];
...
export const vectors3DSubchapters: Subchapter[] = [
  {
    ...
    setuLine: 'Vectors mein direction aur magnitude dono matter karte hain.'
  },
  {
    id: 'math-11-2',
    chapterId: 'math-11',
    ...
    setuLine: 'Dot = projection, Cross = area. Angle finding mein use karo.'
  },
  {
    id: 'math-11-3',
    chapterId: 'math-11',
    ...
    setuLine: 'Line = point + direction. Shortest distance box product use karo.'
  },
  {
    id: 'math-11-4',
    chapterId: 'math-11',
    ...
    setuLine: 'Plane = normal vector defines orientation. r·n = d form useful.'
  }
];
...
export const trigonometrySubchapters: Subchapter[] = [
  {
    ...
    setuLine: 'Trig identities yaad karo. Simplification mein help karte hain.'
  },
  {
    id: 'math-12-2',
    chapterId: 'math-12',
    ...
    setuLine: 'General solution mein n integer. Domain check karna mat bhoolna.'
  },
  {
    id: 'math-12-3',
    chapterId: 'math-12',
    ...
    setuLine: 'Inverse trig mein domain-range important. Principal value range yaad karo.'
  },
  {
    id: 'math-12-4',
    chapterId: 'math-12',
    ...
    setuLine: 'Triangle mein sine rule side ke opposite angle. Cosine rule 3 sides se angle.'
  }
];
...
export function getSubchaptersByChapterId(chapterId: string): Subchapter[] {
  if (chapterId.startsWith('sch-')) {
    ...
    return [{
      ...
      setuLine: 'School ka foundation strong rakho, aage kaam aayega.'
    }];
  }
