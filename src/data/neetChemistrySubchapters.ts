...
export const neetChem1Subchapters: Subchapter[] = [
    {
        ...
        setuLine: 'VSEPR = lone pairs push harder. Count them on central atom, predict shape.'
    },
    {
        id: 'neet-chem-1-2',
        chapterId: 'neet-chem-1',
        ...
        setuLine: 'Formula: Hybridization = sigma bonds + lone pairs on central atom. Trust this always.'
    },
    {
        id: 'neet-chem-1-3',
        chapterId: 'neet-chem-1',
        ...
        setuLine: 'O2 paramagnetic is NEET favourite. Fill like Aufbau, then count unpaired.'
    },
    {
        id: 'neet-chem-1-4',
        chapterId: 'neet-chem-1',
        ...
        setuLine: 'Fajan\'s rules: small cation + large anion = more covalent. Simple logic.'
    },
    {
        id: 'neet-chem-1-5',
        chapterId: 'neet-chem-1',
        ...
        setuLine: 'H-bond between N/O/F only. Intramolecular H-bond means lower BP — tricky trap.'
    },
];
...
export const neetChem2Subchapters: Subchapter[] = [
    {
        ...
        setuLine: 'Stability of carbocation: 3° > 2° > 1° > methyl. Hyperconjugation makes 3° extra stable.'
    },
    {
        id: 'neet-chem-2-2',
        chapterId: 'neet-chem-2',
        ...
        setuLine: 'Chiral center = 4 different groups on C. meso = chiral centers cancel out.'
    },
    {
        id: 'neet-chem-2-3',
        chapterId: 'neet-chem-2',
        ...
        setuLine: 'Markovnikov: H goes to carbon that already has more H. Peroxide reverses for HBr only.'
    },
    {
        id: 'neet-chem-2-4',
        chapterId: 'neet-chem-2',
        ...
        setuLine: 'Named reactions table: reactant, reagent, product. Make flashcards. Direct marks.'
    },
];
...
export const neetChem3Subchapters: Subchapter[] = [
    {
        ...
        setuLine: 'Hess\'s law = adjust equations like algebra. Enthalpy is path-independent.'
    },
    {
        id: 'neet-chem-3-2',
        chapterId: 'neet-chem-3',
        ...
        setuLine: 'ΔG negative = spontaneous. Remember all 4 sign combinations of ΔH and ΔS.'
    },
    {
        id: 'neet-chem-3-3',
        chapterId: 'neet-chem-3',
        ...
        setuLine: 'Le Chatelier: stress → system shifts to relieve it. Catalyst only speeds reaching Keq.'
    },
];
...
export const neetChem4Subchapters: Subchapter[] = [
    {
        ...
        setuLine: 'IUPAC name: ligands first (alphabetically), then metal with oxidation state. Practice 10 names.'
    },
    {
        id: 'neet-chem-4-2',
        chapterId: 'neet-chem-4',
        ...
        setuLine: 'Square planar shows geometric isomerism. Tetrahedral does not. Cisplatin is cis-form.'
    },
    {
        id: 'neet-chem-4-3',
        chapterId: 'neet-chem-4',
        ...
        setuLine: 'CFSE calculation: count unpaired electrons then calculate. Spectrochemical series = must memorize.'
    },
];
...
export const neetChem5Subchapters: Subchapter[] = [
    {
        ...
        setuLine: 'Sucrose non-reducing, glucose+fructose reducing. Alpha/beta differ at anomeric C1.'
    },
    {
        id: 'neet-chem-5-2',
        chapterId: 'neet-chem-5',
        ...
        setuLine: 'Peptide bond count = (n-1). Zwitterion has + and - in same molecule.'
    },
    {
        id: 'neet-chem-5-3',
        chapterId: 'neet-chem-5',
        ...
        setuLine: 'ADEK fat-soluble. A-T (2 H-bonds), G-C (3 H-bonds). RNA has U instead of T.'
    },
];
...
export const neetChem6Subchapters: Subchapter[] = [
    {
        ...
        setuLine: 'EMF = Ecathode - Eanode. Higher SRP = cathode. Easy if you remember this.'
    },
    {
        id: 'neet-chem-6-2',
        chapterId: 'neet-chem-6',
        ...
        setuLine: 'Nernst: E = E° - 0.0591/n × logQ. Simple formula, must know when to use Q.'
    },
    {
        id: 'neet-chem-6-3',
        chapterId: 'neet-chem-6',
        ...
        setuLine: 'First order t1/2 = 0.693/k. Arrhenius: higher Ea = more temp sensitive.'
    },
];
...
export const neetChem7Subchapters: Subchapter[] = [
    {
        ...
        setuLine: 'P-block: learn basicity trend and oxoacid structures from NCERT. Direct questions.'
    },
    {
        id: 'neet-chem-7-2',
        chapterId: 'neet-chem-7',
        ...
        setuLine: 'Halogens oxidising power decreases down. F has no d-orbital so no hypervalency.'
    },
    {
        id: 'neet-chem-7-3',
        chapterId: 'neet-chem-7',
        ...
        setuLine: 'Cr and Cu have exceptional configs. Learn them separately. Variable OS from (n-1)d electrons.'
    },
];
...
export const neetChem8Subchapters: Subchapter[] = [
    {
        ...
        setuLine: 'Colligative = depends on solute particles, not identity. Van\'t Hoff i = key.'
    },
    {
        id: 'neet-chem-8-2',
        chapterId: 'neet-chem-8',
        ...
        setuLine: 'FCC = 4 atoms, BCC = 2, SC = 1. Packing: FCC 74%, BCC 68%, SC 52%. Memorize.'
    },
];
