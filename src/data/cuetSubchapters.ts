...
export const cuetGT1Subchapters: Subchapter[] = [
  {
    ...
    setuLine: 'Syllogisms are about logic, not language. Draw the Venn diagram every time.'
  },
  {
    ...
    setuLine: 'Write the alphabet with numbers 1-26. It saves time every single time.'
  },
  {
    ...
    setuLine: 'Always draw the family tree. No shortcuts here.'
  },
  {
    ...
    setuLine: 'Puzzles are about elimination. Start with the most constrained condition.'
  },
];
...
export const cuetGT2Subchapters: Subchapter[] = [
  {
    ...
    setuLine: 'Learn fraction equivalents: 1/4 = 25%, 1/3 = 33.3%. Speed increases dramatically.'
  },
  {
    ...
    setuLine: 'Convert speed: multiply by 5/18 for m/s, 18/5 for km/hr. Memorize this.'
  },
  {
    ...
    setuLine: 'Alligation is the fastest method for mixture problems. Learn it well.'
  },
];
...
export const cuetGT3Subchapters: Subchapter[] = [
  {
    ...
    setuLine: 'Learn Articles 12-35 (FR) and 36-51 (DPSP) thoroughly. They repeat every year.'
  },
  {
    ...
    setuLine: 'Use maps actively while studying. Visual memory is strongest for geography.'
  },
  {
    ...
    setuLine: 'Read a monthly current affairs PDF. 30 minutes daily is enough.'
  },
];
...
export const cuetGT4Subchapters: Subchapter[] = [
  {
    ...
    setuLine: 'DI is the easiest scoring area. Practice reading charts quickly.'
  },
  {
    ...
    setuLine: 'For series: first check +/-, then ×/÷, then squares/cubes. Systematic approach wins.'
  },
];
...
export const cuetEng1Subchapters: Subchapter[] = [
  {
    ...
    setuLine: 'Read the questions first. Then scan the passage for answers. Never read word by word.'
  },
  {
    ...
    setuLine: 'Context is king. The same word means different things in different sentences.'
  },
];
...
export const cuetEng2Subchapters: Subchapter[] = [
  {
    ...
    setuLine: 'Error spotting has patterns. Learn the 20 most common grammar rules and you cover 90% of questions.'
  },
  {
    ...
    setuLine: 'Learn 10 new words daily with usage. In 3 months you will cover everything CUET asks.'
  },
];
...
export const cuetEng3Subchapters: Subchapter[] = [
  {
    ...
    setuLine: 'Find the first and last sentence. The middle falls into place automatically.'
  },
  {
    ...
    setuLine: 'Read the entire cloze passage once. The theme tells you which words fit.'
  },
];
...
export const cuetEco1Subchapters: Subchapter[] = [
  {
    ...
    setuLine: 'If price changes → movement. If anything else changes → shift. This one rule solves 80% of questions.'
  },
  {
    ...
    setuLine: 'Equilibrium = where marginal values meet. This applies everywhere in economics.'
  },
  {
    ...
    setuLine: 'Make a comparison table of all 4 market forms. One table covers 15+ possible questions.'
  },
];
...
export const cuetEco2Subchapters: Subchapter[] = [
  {
    ...
    setuLine: 'GDP = C + I + G + (X-M). This formula appears in almost every CUET economics paper.'
  },
  {
    ...
    setuLine: 'RBI controls money supply. Government controls fiscal policy. Never mix these two.'
  },
];
...
export const cuetEco3Subchapters: Subchapter[] = [
  {
    ...
    setuLine: '1991 is the turning point. Know what changed and why. Half the questions come from this era.'
  },
];
...
export const cuetPS1Subchapters: Subchapter[] = [
  {
    ...
    setuLine: 'Learn all 6 fundamental rights with their article numbers. Direct questions guaranteed.'
  },
  {
    ...
    setuLine: 'Union List, State List, Concurrent List. Know 10 items from each. That is enough for CUET.'
  },
];
...
export const cuetPS2Subchapters: Subchapter[] = [
  {
    ...
    setuLine: 'Make a timeline from 1945 to 1991. Cold War is all about chronology.'
  },
];
...
export const cuetHist1Subchapters: Subchapter[] = [
  {
    ...
    setuLine: 'Ancient India = know the key features of each dynasty. Tables work best here.'
  },
  {
    ...
    setuLine: 'Medieval India = rulers and their contributions. Make flashcards for each ruler.'
  },
];
...
export const cuetHist2Subchapters: Subchapter[] = [
  {
    ...
    setuLine: 'Learn the timeline: 1857 → 1885 → 1905 → 1919 → 1920 → 1930 → 1942 → 1947. Each year is a turning point.'
  },
  {
    ...
    setuLine: 'World History = causes and consequences. Every revolution has a pattern: oppression → uprising → change.'
  },
];
...
export const cuetGeo1Subchapters: Subchapter[] = [
  {
    ...
    setuLine: 'Physical Geography is about processes. Understand WHY things happen, not just WHAT.'
  },
  {
    ...
    setuLine: 'Human Geography = people and patterns. Focus on WHY people do what they do.'
  },
];
...
export const cuetGeo2Subchapters: Subchapter[] = [
  {
    ...
    setuLine: 'Study with the map open. Geography without maps is like maths without formulas.'
  },
];
...
export const cuetPsy1Subchapters: Subchapter[] = [
  {
    ...
    setuLine: 'Learn each school with its founder and key idea. One table covers everything.'
  },
  {
    ...
    setuLine: 'Negative reinforcement ≠ punishment. This is the most common trap in psychology exams.'
  },
];
...
export const cuetPsy2Subchapters: Subchapter[] = [
  {
    ...
    setuLine: 'Freud, Jung, Rogers, Maslow, Allport — learn their ONE key contribution each.'
  },
  {
    ...
    setuLine: 'Disorders = know the symptoms. Therapy = know the approach. Keep them separate.'
  },
];
...
export const cuetSoc1Subchapters: Subchapter[] = [
  {
    ...
    setuLine: 'Caste is ascribed, class is achieved. This distinction is fundamental.'
  },
  {
    ...
    setuLine: 'Social movements = know the leader, the cause, and the outcome. Three things per movement.'
  },
];
...
export const cuetAcc1Subchapters: Subchapter[] = [
  {
    ...
    setuLine: 'Partnership = ratios and journal entries. Practice 10 problems and you will see the pattern.'
  },
  {
    ...
    setuLine: 'Dissolution has a fixed format. Learn it once, apply everywhere.'
  },
];
...
export const cuetAcc2Subchapters: Subchapter[] = [
  {
    ...
    setuLine: 'Shares and Debentures = know the journal entries for each scenario. They are fixed.'
  },
  {
    ...
    setuLine: 'Learn 12 key ratios with formulas. CUET repeats the same ratios every year.'
  },
];
...
export const cuetBS1Subchapters: Subchapter[] = [
  {
    ...
    setuLine: 'Fayol = 14 principles (administrative). Taylor = scientific management (shop floor). Never mix them.'
  },
  {
    ...
    setuLine: 'Business Studies is about processes. Learn the steps, apply to case studies.'
  },
];
...
export const cuetBS2Subchapters: Subchapter[] = [
  {
    ...
    setuLine: 'Money market = short term. Capital market = long term. Everything else follows from this.'
  },
  {
    ...
    setuLine: 'Consumer Protection Act 2019 replaced the 1986 Act. Know the new provisions — they are always asked.'
  },
];
