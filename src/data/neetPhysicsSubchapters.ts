...
export const neetPhy1Subchapters: Subchapter[] = [
    {
        ...
        setuLine: 'Projectile: split into horizontal and vertical. Time same for both. Simple physics.'
    },
    {
        id: 'neet-phy-1-2',
        chapterId: 'neet-phy-1',
        ...
        setuLine: 'FBD first, equations later. Never skip drawing forces. Newton ka second law: net F = ma.'
    },
    {
        id: 'neet-phy-1-3',
        chapterId: 'neet-phy-1',
        ...
        setuLine: 'In collision: momentum always conserved. KE conserved only in elastic (e = 1).'
    },
    {
        id: 'neet-phy-1-4',
        chapterId: 'neet-phy-1',
        ...
        setuLine: 'Escape velocity = √2 × orbital velocity. This ratio is exam favourite.'
    },
    {
        id: 'neet-phy-1-5',
        chapterId: 'neet-phy-1',
        ...
        setuLine: 'Soap bubble: 4T/r (two surfaces). Liquid drop: 2T/r (one surface). Key difference.'
    },
];
...
export const neetPhy2Subchapters: Subchapter[] = [
    {
        ...
        setuLine: 'Carnot efficiency = 1 - TL/TH. Only depends on temperatures, not working substance.'
    },
    {
        id: 'neet-phy-2-2',
        chapterId: 'neet-phy-2',
        ...
        setuLine: 'vrms : vavg : vmp = 1.73 : 1.60 : 1.41. vrms is always the largest.'
    },
];
...
export const neetPhy3Subchapters: Subchapter[] = [
    {
        ...
        setuLine: 'E = 0 inside conductor but V is not zero. This distinction is very important.'
    },
    {
        id: 'neet-phy-3-2',
        chapterId: 'neet-phy-3',
        ...
        setuLine: 'Wheatstone balanced: P/Q = R/S, Ig = 0. Potentiometer uses zero deflection method.'
    },
    {
        id: 'neet-phy-3-3',
        chapterId: 'neet-phy-3',
        ...
        setuLine: 'Battery removed = Q fixed. Battery connected = V fixed. This changes everything.'
    },
];
...
export const neetPhy4Subchapters: Subchapter[] = [
    {
        ...
        setuLine: 'Magnetic force never does work (always perpendicular to v). Remember this always.'
    },
    {
        id: 'neet-phy-4-2',
        chapterId: 'neet-phy-4',
        ...
        setuLine: 'Lenz law: induced current opposes change. Resonance: XL = XC, Z minimum.'
    },
];
...
export const neetPhy5Subchapters: Subchapter[] = [
    {
        ...
        setuLine: 'Sign convention: incident light direction = +x. All distances from optical centre. Stick to it.'
    },
    {
        id: 'neet-phy-5-2',
        chapterId: 'neet-phy-5',
        ...
        setuLine: 'YDSE fringe width = λD/d. Increase D or λ, fringes widen. Increase d, fringes narrow.'
    },
    {
        id: 'neet-phy-5-3',
        chapterId: 'neet-phy-5',
        ...
        setuLine: 'Photoelectric: KE = hf - work function. Higher frequency = more energy. NOT intensity.'
    },
];
...
export const neetPhy6Subchapters: Subchapter[] = [
    {
        ...
        setuLine: 'SHM: v max at mean, a max at extreme. Energy alternates between KE and PE.'
    },
    {
        id: 'neet-phy-6-2',
        chapterId: 'neet-phy-6',
        ...
        setuLine: 'Closed pipe: odd harmonics. Open pipe: all harmonics. Doppler: source approaches → freq increases.'
    },
];
