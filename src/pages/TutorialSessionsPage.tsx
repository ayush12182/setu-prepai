...
const tutorialNotes = {
  physics: {
    '11': [
      ...
      { id: 'phy-11-4', title: 'System of Particles & COM', status: 'coming-soon', pages: 35 },
      { id: 'phy-11-5', title: 'Rotational Motion Deep Dive', status: 'coming-soon', pages: 55 },
      { id: 'phy-11-6', title: 'Gravitation Notes', status: 'coming-soon', pages: 30 },
      { id: 'phy-11-7', title: 'Properties of Solids', status: 'coming-soon', pages: 28 },
      { id: 'phy-11-8', title: 'Properties of Fluids', status: 'coming-soon', pages: 32 },
      { id: 'phy-11-9', title: 'SHM & Waves Bundle', status: 'coming-soon', pages: 48 },
      { id: 'phy-11-10', title: 'Thermodynamics Complete', status: 'coming-soon', pages: 40 },
    ],
    '12': [
