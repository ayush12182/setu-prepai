        ...
        <div className="space-y-8 text-white/70 leading-relaxed">
          <section>
            ...
            <ul className="list-disc list-inside space-y-2">
              ...
              <li><strong className="text-white/90">Uploaded Content:</strong> Handwritten notes or lecture videos you upload for AI-powered analysis via Lecture PrepEntrance.</li>
              <li><strong className="text-white/90">Chat Data:</strong> Conversations with PrepEntrance Mentor AI teacher to provide contextual academic guidance.</li>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-2">
              ...
              <li>Enable PrepEntrance Mentor AI to give you motivational and strategic exam guidance.</li>
            </ul>
          ...
          <section>
            ...
            <p>PrepEntrance uses AI models (Google Gemini, OpenAI) to generate questions, notes, and teacher responses. Your academic queries and uploaded content may be processed by these services solely to deliver features. No personal identity data is shared with AI providers. We do not use any third-party advertising or tracking services.</p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-white mb-3">5. Cookies</h2>
            <p>We use essential cookies only — to keep you logged in and remember your preferences (language, theme). No third-party advertising or analytics cookies are used on PrepEntrance.</p>
          </section>
          ...
          <section>
            ...
            <p>PrepEntrance is designed for students aged 15 and above preparing for JEE. We do not knowingly collect data from children under 13. If you believe a child under 13 has provided us data, please contact us immediately.</p>
          </section>

          <section>
            <h2 className="text-xl font-semibold text-white mb-3">8. Changes to This Policy</h2>
            <p>We may update this Privacy Policy from time to time. Any changes will be posted on this page with an updated revision date. Continued use of PrepEntrance after changes constitutes acceptance.</p>
          </section>
